...
chapter \<open>Security Protocol Infrastructure\<close>

text \<open>This chapter sets up our modeling infrastructure for security protocol verification, in 
particular a Dolev-Yao model. Some of the theories contained in this chapter have been previously
published.\<close>
